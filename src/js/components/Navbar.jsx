...
const Navbar = () => {
        ...
        return (
            ...
            <nav className="navbar navbar-expand-lg bg-body-tertiary ">
                    <div className="BARRA container-fluid  ">
                        <a className="text1 navbar-brand" href="#"> <span className="bluetext">Somos </span> Galipán  </a>
                        ...
                        <ul className="navbar-nav">
                            ...
                            <a className="text1 nav-link active" aria-current="page" href="#">Home</a>
                            </li>
                            <li className="nav-item">
